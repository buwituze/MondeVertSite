  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="flex-1">
        ...
        <section id="ways-to-help" className="w-full py-12 md:py-24">
          <div className="container px-4 md:px-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-lg bg-white border p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Provide technology, art supplies, or expertise to support
                  ...
                  <div className="rounded-lg bg-white border p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      and promotes your organization's commitment to
                      sustainability.
                    </p>
                  </div>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
                  Together with our supporters, volunteers, and partners, we're
                  creating a more sustainable Rwanda through creative
